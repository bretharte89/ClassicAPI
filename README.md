...
| GameTooltip | `GameTooltip:GetItem`, `GameTooltip:GetSpell`, `GameTooltip:HasItem`, `GameTooltip:HasSpell`, `GameTooltip:SetInventoryItemByID`, `GameTooltip:SetItemByID`, `GameTooltip:SetSpellByID`, `GameTooltip:SetTalentByID`, `GameTooltip:SetUnitAura` |
...
| Quest | `C_QuestLog.GetTitleForQuestID`, `C_QuestLog.GetQuestIDFromLogIndex`, `C_QuestLog.RequestLoadQuestByID` |
