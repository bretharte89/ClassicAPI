...
| Namespace | Calls |
|-----------|-------|
| Spell     | `GetSpellInfo` (with `(slot, bookType)` overload), `C_Spell.GetSpellInfo`, `C_Spell.GetSpellName`, `C_Spell.GetSpellTexture`, `FindSpellBookSlotByID`, `GameTooltip:SetSpellByID`, `C_Spell.GetSpellDescription` |
